    ...
    <>
            ...
            <div className="row">
              <div className="col-md-7 d-flex align-items-center justify-content-center pe-5">
                <div className="text-section">
                  ...
                  With years of expertise in mobile app consulting, Digital Frog has built a legacy of delivering exceptional services to our partners and clients. From initial app audits to mobile API development, Digital Frog provides comprehensive solutions to create competitive, high-performing apps. Digital Frog’s mobile consulting team excels in agile methodologies, focusing on efficient planning, design, and development to craft engaging mobile experiences.
      ...
      <div className="container right-let-mid appMobilePadding">
        <div className="row">
          ...
          <div className="col-md-6 d-flex align-items-start justify-content-center flex-column paddingLeft3 gap-3">
            ...
            Our mobile app audits are designed to assess security, compliance, and functionality, helping to identify and address any vulnerabilities or breaches. Digital Frog offers expert guidance in optimizing mobile app performance and ensuring adherence to industry standards and regulations.
            </p>
            <DropUsALine />
          </div>
        </div>
      ...
      <div className="container right-let-mid appMobilePadding">
        <div className="row">
          <div className="col-md-6 d-flex align-items-start justify-content-center flex-column pe-5 gap-3">
            ...
            <p className="paragraphText">
            As technology evolves, so must your mobile apps. Digital Frog helps modernize and enhance your existing mobile applications, incorporating the latest features and strategies to boost user engagement. Our approach ensures your app remains relevant in a fast-changing digital landscape.
            </p>
            <DropUsALine />
          </div>
      ...
      <div className="container right-let-mid appMobilePadding">
        <div className="row">
          ...
          <div className="col-md-6 d-flex mgTop25 align-items-start justify-content-center flex-column paddingLeft3 gap-3">
            ...
            <p className="paragraphText">
            In today's digital age, the design of mobile apps is crucial for user engagement, accessibility, and overall experience. At Digital Frog, we offer cost-effective design solutions for all mobile platforms—whether Native, Hybrid, or Cross-Platform—to ensure your app stands out in a crowded market.
            </p>
            <DropUsALine />
          </div>
        </div>
      ...
      <div className="orange-wrap py-5 appMobilePaddingSmall">
        <div className="container py-5 text-center">
          ...
          <p className="paragraphText">
          With over a decade of unmatched experience in mobile consulting and development, Digital Frog has established itself as a leader in<br /> the digital technology landscape. Digital Frog has helped countless industries and brands flourish by implementing<br /> innovative strategies and simplifying formulas for driving growth in both mobile and web development.
          </p>
          <div className="row">
