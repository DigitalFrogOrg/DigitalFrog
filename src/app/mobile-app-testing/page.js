      ...
      <div className="container app-testing appMobilePadding" >
        <div className="row">
          <div className="col-md-6 d-flex align-items-start justify-content-center flex-column">
            ...
            With years of proven success, Digital Frog offers top-tier mobile app testing services that deliver fast, flawless applications ready to stand out in the competitive digital market. Digital Frog focuses on scaling businesses by ensuring seamless performance, superior usability, optimal efficiency, risk-free compatibility, and innovative solutions for growth in the digital space.
            </p>
           <DropUsALine />
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 d-flex align-items-start justify-content-center flex-column">
              ...
              Digital Frog offers premium mobile app testing services, leveraging automated testing to deliver fast and effective solutions, ensuring flawless performance and optimal user experience.
              </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-7">
              <h2 className="mainHeadingMobile">Why Choose Digital Frog</h2>
              <p className="paragraphText">
              Digital Frog offers top-tier mobile app testing services, utilizing highly effective testing methodologies to prevent issues and deliver the most reliable solutions for our clients and partners.
              </p>
            </div>
