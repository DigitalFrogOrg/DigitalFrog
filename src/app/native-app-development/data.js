export const faqData = [
  ...
  export const cynergyKnack = [
    ...
    {heading:"Feature-Rich Solutions",imgUrl:"renewable_26533201.png",description:"Digital Frog deliver apps packed with smart features that enhance functionality and user satisfaction."},
    {heading:"Enhanced Security",imgUrl:"graphic-design_699245.png",description:"Built with advanced security protocols, Digital Frog’s native apps protect your data from potential threats, ensuring confidentiality and reliability."},
  ]

  export const whyChooseUs = [
    {heading:"High-Quality App",description:"Digital Frog’s native app development services focus on creating high-quality, robust applications that boost brand visibility and foster stronger audience engagement. By offering seamless experiences on both Android and iOS platforms, we help drive revenue and improve user loyalty. Explore Digital Frog premium solutions that will help your native app thrive in the marketplace."},
    {heading:"Improved Security",description:"Security is at the forefront of our native app development approach. With built-in encryption, secure data storage, and robust privacy features, Digital Frog ensures your app meets industry standards. Both iOS and Android platforms benefit from our secure development practices, helping you protect user data while complying with privacy regulations, so your business remains credible and trustworthy."},
    {heading:"Ability to work offline",description:"Native apps are designed to offer offline capabilities, allowing users to access key features and content even without an internet connection. This is especially beneficial for apps in categories such as gaming, reading, or productivity. With Digital Frog’s native development process, you can ensure your app delivers optimal performance, no matter the connectivity scenario."},
    {heading:"App Store Visibility and Monetization",description:"By developing native apps, we unlock significant opportunities for your app's visibility on the App Store and Google Play Store. Digital Frog’s expert app developers ensure that your app is designed to meet platform guidelines and optimized for search rankings. This leads to better discoverability, ratings, and reviews, ultimately driving user engagement and monetization."},
    {heading:"Enhanced User Experience",description:"Native applications leverage the unique features of each device, offering an intuitive and optimized user experience. By utilizing platform-specific software development kits (SDKs), Digital Frog ensures that your app functions smoothly, delivers high performance, and remains user-friendly. Native apps ensure seamless integration with device hardware, enhancing both functionality and offline capabilities."},
    {heading:"Cost Effectiveness",description:"While native app development requires a higher initial investment, the long-term benefits far outweigh the costs. By focusing on the latest technologies and best practices, we develop cost-effective, custom solutions that scale with your business. Digital Frog’s team ensures that your native app not only meets your business goals but also delivers a superior user experience, making it a worthwhile investment for your company’s growth."},
  ]