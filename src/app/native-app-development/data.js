export const faqData = [
  ...
  export const cynergyKnack = [
    ...
    {heading:"End-to-End Testing",imgUrl:"renewable_26533201.png",description:"Make your iOS mobile app journey vibrant and protected with Dignite Studios. We systemize the entire process of designing iOS apps with full-end testing service to ensure the integrity and believability of an app. We burgeon to yield adequate strategies to make your iOS UIUX design guarded and secured."},
