  ...
  return (
    <>
      ...
      >
        <div className="row">
          <div className="col-md-6 d-flex align-items-start justify-content-center flex-column gap-4">
            ...
            Digital wolf's offers comprehensive solutions tailored to meet your unique business goals, leveraging the latest technology. 
            </p>
            <DropUsALine />
          </div>
      ...
      <div className="container midMobileAdd appMobilePadding">
        ...
        Digital wolf's builds feature-rich Android apps using advanced tech stacks. Our expert developers consistently<br /> exceed industry standards, delivering creative and robust Android applications that enhance user experiences.<br /> Digital wolf's focuses on developing powerful, reliable apps that align with your vision and business objectives.
        </p>
        <div style={{marginTop:'6rem'}} className="row">
          ...
          <div className="col-md-3 d-flex mgTop25 align-items-center justify-content-evenly flex-column">
            <div className="panelBoxRight m-0">
              ...
              <p className="smallParaText">
              Quality is our top priority. Digital Frog employs a rigorous testing process to ensure that every Android app is free from bugs and performs seamlessly. Our comprehensive testing strategies ensure that your app is optimized for performance, providing users with a flawless experience and eliminating any barriers to smooth operation.
              </p>
            </div>
            <div cassName="panelBoxRight m-0">
              <h4 className="lineHeading">Maintenance and Update</h4>
              <p className="smallParaText">
              Our Android app developers provide ongoing maintenance and updates to ensure your app stays current and performs optimally. Hire Digital Frog's experts to guarantee your app remains secure, efficient, and aligned with evolving user needs and technological advancements.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container androidDeveloper appMobilePadding">
        <div className="row">
          ...
          <div className="col-md-6 footerSection">
            ...
            Our Android developers bring a wealth of expertise and advanced technical skills to every project. From creating powerful apps to optimizing performance, our team delivers reliable and scalable solutions. Digital Frog offers a broad range of Android app developers with diverse expertise to suit your specific project needs.
            </p>
