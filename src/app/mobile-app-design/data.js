export  const faqData = [
  ...
  export const topNotch = [
    {heading:"Strategic Free Consultation",description:"Curious about how Digital Frog ensures seamless project flow for software development? Our skilled consultants guide businesses through effective planning that boosts conversions and broadens audience engagement, ensuring long-term business success."},
    {heading:"UI/UX Research & Strategy",description:"Our comprehensive research process involves interviews, usability testing, surveys, and data analysis to understand user behavior. Digital Frog applies the most suitable approach to design mobile app experiences that align with consumer expectations, ensuring superior results."},
    {heading:"Informative Architectural Layout",description:"A well-structured architectural layout is crucial for effective User-Interface design. Digital Frog enhances usability by conducting thorough UX audits to optimize navigation and functionality, ensuring a seamless experience and maximizing user satisfaction."},
    {heading:"Wireframing",description:"Wireframing serves as a blueprint for mobile app design, allowing us to visualize and evaluate the user experience before finalizing the product. Digital Frog creates detailed wireframes that ensure smooth functionality and scalability for your app."},
    {heading:"Intuitive User-Interface",description:"At this stage, Digital Frog crafts the actual shape and structure of the app. Our expert team designs intuitive mobile app UIs that focus on the product’s aesthetics, behavior, style guide, and user interaction to elevate business success."},
    {heading:"Iteration",description:"Throughout the development process, the mobile app design undergoes multiple phases, including testing, reviewing, and gathering feedback. Digital Frog ensures that the design aligns with your vision, requirements, and brand voice at every stage."},
    {heading:"Prototyping",description:"In the prototyping phase, design ideas are refined and tested through various iterations, helping the team quickly improve and experiment with concepts. At Digital Frog, we create highly optimized apps that meet your unique needs and goals."},
    {heading:"Deployment",description:"Before deploying your app on the Apple Store or Google Play, Digital Frog ensures that all app functionalities and visual elements are perfect. We follow best practices to ensure a secure and efficient deployment process that saves time and meets your expectations."},
  ]

  export const benefits = [
    {heading:"Recognizable Brand",description:"Transform your brand with Digital Frog’s exceptional mobile app design services that incorporate cutting-edge digital technology. As smartphones have become an integral part of daily life, we create innovative and user-friendly app designs that exceed user expectations and simplify navigation, while aligning with your business goals and achievements."},
    {heading:"Galvanizing Designs",description:"Our dynamic brand styling and impactful UI elements elevate your brand identity, foster user engagement, and boost business conversions. Digital Frog stays on top of the latest design trends, ensuring your mobile app embraces modern UI/UX innovations that captivate users and stand out in the market."},
    {heading:"Data-Driven Strategies",description:"With over 4 years of expertise, Digital Frog utilizes data-driven strategies to design app layouts that enhance user experience. By leveraging original data insights, we create tailored designs that improve engagement and optimize functionality, making every aspect of your app efficient and user-centered."},
