      ...
      <div style={{overflowX:'hidden'}} className="container py-5 my-5 appMobilePaddingSmall">
        ...
        <div className="row d-flex justify-content-center">
          <div className="col-md-7">
            ...
            Digital Frog stands out for its unmatched creativity and expertise in delivering cutting-edge solutions for designing exceptional user interfaces that elevate user experiences to the highest level.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 py-5">
              ...
              Digital Frog brings together a top-tier team of designers who focus on creating seamless and effective operational mechanisms tailored to meet our clients' needs. From modern UI designs to sleek layouts, our experts develop intuitive, unique designs that enhance user experience and drive engagement.
              </p>
            </div>
            ...
            <div className="col-md-6">
              <div className="m-1 inner-blog-section-1 row">
                <div className="col-md-6">
                  ...
                  Native apps are crafted specifically for one mobile operating system, such as iOS or Android, and cannot be used on other platforms. At Digital Frog, we specialize in creating compelling and user-friendly UX designs that attract and engage users quickly on their native platforms.
                  </p>
                </div>
            ...
            <div className="col-md-6 mgTop25">
              <div className="m-1 inner-blog-section-2 row">
                <div className="col-md-6">
                  ...
                  Cross-platform apps are designed to function across multiple operating systems like iOS and Android using a unified code base. Digital Frog delivers efficient cross-platform designs that ensure a smooth user experience, making apps versatile and accessible on a variety of devices.
                  </p>
                  <br />
                  <br />
                </div>
        ...
        <div className="row">
          ...
          <div className="col-md-7 paddingLeft3 footerSection">
            <h2 className="mainHeadingMobile">
              Benefits Of Digital Frog <br /> Studios
            </h2>
            <div className="row">
