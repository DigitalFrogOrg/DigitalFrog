  ...
  return (
    <>
          ...
          <div className="row">
            <div className="col-md-7 d-flex align-items-center justify-content-center">
              <div className="text-section">
                ...
                With years of experience in the digital landscape, we at Digital Frog have continuously adapted to the changing needs of mobile and web app development. Digital Frog’s mission is to design innovative and functional applications for clients globally. 
                <br />
                <br />
                We take pride in crafting unique, customized solutions that meet the ever-evolving needs of businesses, resulting in successful partnerships and impactful projects. Digital Frog’s dedication to technology, creativity, and client satisfaction has earned us recognition in numerous industry rankings.
                </p>
                <DropUsALine />
              </div>
            </div>
            ...
            <div className="col-md-6 mt-5">
              <div className="accordion mt-2" id="accordionExample">
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                     Digital Frog's front-end development expertise transforms designs into interactive, high-performing digital experiences. Using the latest technologies and responsive frameworks, we build web and app interfaces that deliver fast, seamless, and engaging user experiences. Our solutions ensure cross-platform compatibility and flawless functionality across all devices and browsers.
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div
        ...
        style={{ backgroundColor: "#2b90c31e", padding: "30px 0px 60px 0px" }}
      >
          ...
          <div className="row">
            <div className="col-md-9 py-5 d-flex align-items-center justify-content-center">
              <div className="text-section">
                ...
                Digital Frog follows a detailed and precise software development lifecycle that allows us to craft mobile applications that align with your brand's goals. Our expertise in mobile development ensures that your app is designed to increase user engagement, drive revenue, and gain global visibility. Digital Frog provides a complete mobile solution tailored to your business, optimizing every aspect of your app’s development.
                </p>
              </div>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-md-7  py-2 mgTop25 paddingLeft3 paddingRight3">
              <div className="text-section">
                ...
                <p className="paragraphText">
                Looking for a trusted partner to create your Android app? Our team brings innovative, high-quality solutions to the table, ensuring your business thrives in the Android ecosystem. Digital Frog use the latest tools and techniques to develop apps that are reliable, secure, and functional.
                </p>
              </div>
              <div className="text-section">
                <h1 className="title-page-2">
                ...
                <p className="paragraphText">
                Transform your ideas into extraordinary iOS applications. From the initial coding phase to the final launch, Digital Frog’s expert developers work with cutting-edge methodologies to create apps that are optimized, scalable, and high-performing across any iOS device. Digital Frog’s focus is on delivering results that drive a strong return on investment for your business.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container case-study py-5 my-5 appMobilePaddingSmall">
        <div className="row">
          <div className="col-md-12">
            ...
            <p className="paragraphText">
            Digital Frog leverages the latest technologies to build high-performance mobile applications. Our expertise in cutting-edge tools ensures seamless user experiences, enabling apps to perform efficiently across all platforms. By incorporating innovations such as artificial intelligence, machine learning, and cloud computing, we push the boundaries of mobile development. Our development process prioritizes scalability, security, and real-time functionality, ensuring that your app stays ahead of the curve.
             {/* Whether it's cross-platform development or integrating the newest trends, Digital Frog empowers businesses with technology solutions that deliver exceptional results and meet evolving industry demands. */}
            </p>
          </div>
        </div>
      </div>
