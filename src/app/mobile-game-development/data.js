...
export const uptoTime = [
    ...
    {heading:"App Analytics",description:"Dignite Studios bestows the best mobile app analytics and allows administrators to collect all the necessary data about the user. Also, it empowers consumers to monitor their mobile app's performance in less time."},
