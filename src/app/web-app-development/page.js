  ...
  return (
    <>
      ...
      <div className="container highAndroid appMobilePadding" >
        ...
        Empower your business with cutting-edge web-based solutions designed to thrive in the ever-evolving digital landscape.<br /> Digital Frog's expertise lies in crafting seamless and scalable web applications tailored to drive exceptional business outcomes. <br />From user-friendly portals to robust enterprise solutions, we redefine possibilities in web app development.
        </p>
        <div className="row">
      ...
      <div className="DesignProcess appMobilePaddingSmall">
        <div className="container">
          ...
          <p className="text-center paragraphText">
          Digital Frog's structured and efficient web app development process ensures the creation of <br /> innovative and high-performing web applications. From initial concepts to deployment,<br /> Digital Frog focuses on delivering seamless solutions that meet your business goals and exceed industry standards.
          </p> 
          <div className="row">
      ...
      <div className="iosDesignProcess appMobilePaddingSmall" style={{ background: "#fff" }}>
        <div className="container">
          <h2 className="mainHeadingMobile">
            Web App Development
            <br /> With{" "}
            <span style={{ color: "#2b90c3" }}>Digital Frog</span>
          </h2>
          <p className="text-center paragraphText">
          Our expert development team provides meticulous, detail-oriented services to enhance your web application's credibility and performance.<br /> Digital Frog prioritize the integrity and security of each development phase, ensuring robust and reliable web solutions.
          </p>
          <div className="row">
      ...
      <div className="WhyChooseUsMobile appMobilePaddingSmall">
        <div className="container">
          ...
          <p className="text-center paragraphText">
          With years of expertise in web application development, Digital Frog stands out for delivering exceptional web solutions.
