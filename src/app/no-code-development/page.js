    ...
    <>
      ...
      <div className="container LowCodeNoCode appMobilePadding">
        <div className="row">
          <div className="col-md-6 d-flex align-items-start justify-content-center flex-column">
            ...
            Digital Frog specializes in leading low-code/no-code platforms like Bubble, OutSystems, and Mendix, enabling businesses to quickly create powerful applications without extensive coding knowledge, streamlining workflows, and reducing development time.
            </p>
            <DropUsALine />
          </div>
      ...
      <div className="DesignProcess appMobilePaddingSmall">
        <div className="container">
          ...
          Digital Frog’s low-code/no-code solutions empower businesses to rapidly create apps and automate processes with minimal coding.<br /> This approach accelerates development, enhances collaboration, and reduces the need for specialized technical expertise.
          </p>
          <div className="row">
