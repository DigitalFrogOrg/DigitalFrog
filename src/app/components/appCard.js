...
export default function AppCard({heading,isSlider=false,imgUrl="",description,isCenter=false,height="206",hoverEffect="",showLine=false}) {
  return (
    <div className={`appCardContainer my-1 hide-scrollbar ${hoverEffect}`} style={{height:height+'px',margin:isSlider && '16px',boxShadow:isSlider ? '0px 5.19px 16.62px 0px #2b90c357':'0px 0px 18px 0px rgba(0, 0, 0, 0.3)'}}>
