                        ...
                        <div className="popup-inner w-100">
                            ...
                            <form onSubmit={handleSubmit} className='popup-form'>
                                ...
                                <div  className='my-3 d-flex align-items-center gap-3'>
                                    ...
                                    <div onClick={handleFileButtonClick} className='underlineHover'>
                            ...
                            <div className='d-flex align-items-center justify-content-end gap-4'>
                                ...
                                <button type='submit' disabled={loading} className='second-btn formBtn'>{loading ? 'Sending...' : 'Send Message'}</button>
                            </div>
                            </form>
                        </div>
                    </div>
