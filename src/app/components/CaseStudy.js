    ...
    <div className="case-study py-5 my-5 appMobilePaddingSmall">
      <div className="row">
        <div className="col-md-12">
          ...
          At Digital Frog, we specialize in developing high-performance mobile applications that deliver seamless experiences across all platforms. Whether it’s Android or iOS, Digital Frog ensures your app functions perfectly by incorporating top-tier user interfaces, robust coding systems, efficient database management, and comprehensive security measures. Digital Frog builds apps that not only meet but exceed expectations, driving success for businesses in the mobile-first world.
          </p>
        </div>
      </div>
      <div className="row">
