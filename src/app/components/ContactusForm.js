        ...
        <div className="col-lg-8 col-md-10 col-sm-12">
          ...
          <form className="contact-form">
            <div className="form-group">
              <input type="text" className="customInput" id="name" placeholder="Name *" />
            </div>
            <div className="row my-3">
            <div className="col-md-6 form-group">
              <input type="text" className="customInput" id="phone" placeholder="Phone number" />
            </div>
            <div className="col-md-6 form-group">
              <input type="email" className="customInput" id="email" placeholder="Email *" />
            </div>
            </div>
            ...
            {/* onClick={handleFileButtonClick} */}
              ...
              <div  className='underlineHover'>
                                    {/* {selectedFile?.name ? selectedFile?.name : "Attach file"}   */}
                                    </div>
