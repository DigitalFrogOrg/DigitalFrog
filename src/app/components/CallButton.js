    ...
    <div
     ...
     {isOpen && 
      <div ref={divRef} className={`callBtnList`}>
        <div style={{backgroundColor:'#2b90c3',color:'white',borderTopRightRadius:'10px',borderTopLeftRadius:'10px',borderTopLeftRadius:'10px'}} className='d-flex border-bottom p-3 align-items-start gap-3'>
          <div>
            <FaHeadphones />
          </div>
          <div>
        ...
        <div className='p-3 border-bottom'>
         ...
         <div>
         <svg width={"20"} xmlns="http://www.w3.org/2000/svg" fill="#2b90c3" viewBox="0 0 24 24" stroke-width="1" stroke="#2b90c3">
         ...
         <div>
         <svg width={"20"} xmlns="http://www.w3.org/2000/svg" fill="#2b90c3" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff">
        ...
        <div className='d-flex align-items-start gap-2'>
         ...
         <div className='d-flex align-items-start py-2 gap-2'>
         <div>
          <FaWhatsapp color='#2b90c3' size={20} />
          </div>
          <div className='underlineHover'>
