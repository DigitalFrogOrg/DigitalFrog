    ...
    <div className="container IOS-services appMobilePadding">
      <div className="row">
        ...
        <div className="row">
          ...
          <button onClick={() => slider?.current?.slickPrev()} style={{border:'none',background:'white',borderRadius:'80px',padding:'0.1px',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:'2px 2px 4px 2px rgba(0, 0, 0, 0.25)'}}>
                            ...
                            <button onClick={() => slider?.current?.slickNext()} style={{border:'none',background:'none'}}>
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
